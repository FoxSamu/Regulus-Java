...
public final class CapsulePolygonSAT {
    ...
    public static void collide( CapsuleCollider a, PolygonalCollider b, ICollisionCollector collector, CanvasContext ctx ) {
    ...
    public static void collide( PolygonalCollider a, CapsuleCollider b, ICollisionCollector collector, CanvasContext ctx ) {
        collide( b, a, c -> collector.addCollision( c.invert() ), ctx );
    }
}
