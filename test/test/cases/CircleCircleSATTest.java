...
import net.regulus.detection.sat.CircleCircleSAT;

public class CircleCircleSATTest implements TestCase, ICollisionCollector {
    ...
    public void tick( double x, double y ) {
        ...
        collisions.clear();
        CircleCircleSAT.collide( collider1, collider2, this );
    }
