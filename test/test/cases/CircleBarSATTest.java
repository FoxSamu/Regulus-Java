...
import net.regulus.detection.sat.CircleBarSAT;

public class CircleBarSATTest implements TestCase, ICollisionCollector {
    ...
    public void tick( double x, double y ) {
        ...
        collisions.clear();
        CircleBarSAT.collide( collider1, collider2, this );
    }
