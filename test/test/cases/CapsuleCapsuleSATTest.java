...
import net.regulus.detection.sat.CapsuleCapsuleSAT;
import net.regulus.geom.Vec2;

public class CapsuleCapsuleSATTest implements TestCase, ICollisionCollector {
    ...
    public String getName() {
        return "Capsule-Capsule SAT Test";
    }
    ...
    public void draw( CanvasContext ctx, double mouseX, double mouseY ) {
        ...
        CapsuleCapsuleSAT.collide( collider1, collider2, this );
