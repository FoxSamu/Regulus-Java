...
import net.regulus.detection.sat.CirclePlaneSAT;

public class CirclePlaneSATTest implements TestCase, ICollisionCollector {
    ...
    public void tick( double x, double y ) {
        ...
        collisions.clear();
        CirclePlaneSAT.collide( collider1, collider2, this );
    }
