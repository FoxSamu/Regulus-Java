...
import net.regulus.detection.sat.CircleCapsuleSAT;
import net.regulus.geom.Vec2;

public class CircleCapsuleSATTest implements TestCase, ICollisionCollector {

    private final CircleCollider collider1 = new CircleCollider();
    private final CapsuleCollider collider2 = new CapsuleCollider();
    private final List<CollisionPrimer> collisions = new ArrayList<>( 1 );

    @Override
    public String getName() {
        return "Circle-Capsule SAT Test";
    }
    ...
    public void draw( CanvasContext ctx, double mouseX, double mouseY ) {
        ...
        ctx.color( TestColors.ORANGE, 0.3 ).drawCircle( collider1 );
        ctx.color( TestColors.BLUE, 0.3 ).drawCapsule( collider2 );
    ...
    public void tick( double x, double y ) {
        ...
        CircleCapsuleSAT.collide( collider1, collider2, this );
    }
    ...
    public void init() {
        ...
        collider2.setRadius( 1 );
        collider2.setLength( 2 );
