...
import net.regulus.detection.sat.PolygonPlaneSAT;

public class RegularPlaneSATTest implements TestCase, ICollisionCollector {
    ...
    public void tick( double x, double y ) {
        ...
        collisions.clear();
        PolygonPlaneSAT.collide( collider1, collider2, this );
    }
