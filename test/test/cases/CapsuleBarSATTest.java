...
import net.regulus.detection.sat.CapsuleBarSAT;
import net.regulus.geom.Vec2;

public class CapsuleBarSATTest implements TestCase, ICollisionCollector {
    ...
    public void tick( double x, double y ) {
        ...
        collisions.clear();
        CapsuleBarSAT.collide( collider1, collider2, this );
    }
