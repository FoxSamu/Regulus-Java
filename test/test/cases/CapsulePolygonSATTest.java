...
import net.regulus.detection.sat.CapsulePolygonSAT;
...
public class CapsulePolygonSATTest implements TestCase, ICollisionCollector {
    ...
    public String getName() {
        return "Capsule-Polygon SAT Test";
    }
    ...
    public void draw( CanvasContext ctx, double mouseX, double mouseY ) {
        ...
        CapsulePolygonSAT.collide( collider1, collider2, this );
